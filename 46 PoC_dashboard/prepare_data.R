...
tick.seq <- seq(as.POSIXct("2016-03-01 23:00:00"), as.POSIXct("2016-03-02 08:32:00"), by = "hour") # http://stackoverflow.com/questions/10887923/hourly-date-sequence-in-r
