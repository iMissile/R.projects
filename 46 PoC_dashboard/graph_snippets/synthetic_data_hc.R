...
generate_field_data <- function(back_days = 7, forward_days = 7) {
  ...
  start_time <- round_date(now(), unit = "day") # дл€ синхронных 4-х часовых измерений необходимо привести к 0:00
...
# сгеренируем json под требовани€ ѕаши ---------------------------------------------------
...
# ќб€зательно надо уровн€ть количество элементов, иначе получаем ошибку: 
