...
df1 <- data.frame(humidity = c(0, 0.2, 0.25, 0.4, 0.6),
                 voltage = c(2578944, 2545344, 1646496, 959744, 953440))

p1 <- ggplot(df1, aes(humidity, voltage)) +
  geom_line() +
  geom_point(shape = 1) +
  geom_smooth()
...
df2 <- data.frame(humidity = c(0, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4),
                 voltage = c(2375232, 2443488, 2441392, 2176768, 1219120, 1375568, 1163456, 947152))

p2 <- ggplot(df2, aes(humidity, voltage)) +
  geom_line() +
  geom_point(shape = 1) +
  geom_smooth()
