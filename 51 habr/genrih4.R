...
Adr <- c("брянская область, г. дятьково, ул. ленина, д. 166", "брянская область, г. дятьково, ул. ленина, д. 166",
"г.дятьково, ул.ленина, д.166", "г.дятьково, ул.ленина, д.166, брянская обл.", "г.дятьково, ул.ленина, д.166 2",
"г. дятьково,ул. ленина, д.166", "г.дятьково, ул.ленина, д.166", "г.дятьково, ул.ленина, д.166, брянская обл.",
"г.дятьково, ул.ленина, д.166 2", "г.лобня, ул.горького, д.104", "г.котельники, мкр н силикат, д.29", 
"московская область, люберецкий район, г. котельники, мкр. силикат, дом 29",
"московская область, люберецкий район, г. котельники, мкр. силикат, дом 29", "мо, г.лобня, ул.горького, д.104", 
"московская область, люберецкий район, поселок котельники, мкр н силикат, д.29", "г.лобня, ул.горького, д.104", 
"г.лобня, ул.горького, д.104", "г.лобня, ул.горького, д.104", "г.котельники, мкр н силикат, д.29",
"г.москва, ул.судостроительная, д.1", "г. москва, судостроительная улица, д. 1", "г. москва, ул. судостроительная, д. 1",
"г.москва, ул. судостроительная, д.1", "г.москва, ул.судостроительная, д.1", "г. москва, ул. судостроительная, д. 1",
"г.москва, ул.судостроительная, д.1", "г. москва, судостроительная улица, д. 1", "г.москва, ул.судостроительная, д.1",
"мо, дмитровский район, д. подосинки", "мо, дмитровский район, д. подосинки", "п.подосинки, г.п.дмитров",
"п.подосинки, г.п.дмитров", "дмитровский р н, п.подосинки", "дмитровский р н, д.подосинки, г.п.дмитров",
"дмитровский р н, п.подосинки", "московская область, дмитровский р н, п.подосинки", "подольский р н, с.вороново, магазин")
#### Геокодер########
...
system.time(l <-
              foreach(
                ...
                .combine = list,
                .multicombine = TRUE,
                .packages = c("rjson", "XML")
              ) %dopar% {
                geoYandex(x, IsAddressFilter = T)
              })
stopImplicitCluster()