...
mttr_value <- c(1, 4, 24) # указано время в часах на восстановление

# == сервер rh1288
rh2288 <- tibble(type=c("Материнская плата", "RAID контроллер", "Процессор", "Оперативная память", 
...
server_rh2288 <- tibble(availability=mtbf1_series / (mtbf1_series + mttr_value/(24*365)), # переводим часы простоя в года
